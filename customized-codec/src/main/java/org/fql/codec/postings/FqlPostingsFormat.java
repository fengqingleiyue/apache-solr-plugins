...
/**
 * see {@link org.apache.lucene.codecs.lucene50.Lucene50PostingsFormat}
 */
public class FqlPostingsFormat extends PostingsFormat {
    /**
    ...
    final static String TERMS_CODEC = "FqlPostingsWriterTerms";
    final static String DOC_CODEC = "FqlPostingsWriterDoc";
    final static String POS_CODEC = "FqlPostingsWriterPos";
    final static String PAY_CODEC = "FqlPostingsWriterPay";
    ...
    public FqlPostingsFormat(int minTermBlockSize, int maxTermBlockSize) {
        super("Fql");
    ...
    public FieldsConsumer fieldsConsumer(SegmentWriteState state) throws IOException {
        PostingsWriterBase postingsWriter = new FqlPostingsWriter(state);
    ...
    public FieldsProducer fieldsProducer(SegmentReadState state) throws IOException {
        PostingsReaderBase postingsReader = new FqlPostingsReader(state);
        boolean success = false;
        try {
