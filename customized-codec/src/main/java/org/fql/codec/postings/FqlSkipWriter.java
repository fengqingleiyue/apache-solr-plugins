 ...
 * see {@link org.apache.lucene.codecs.lucene50.Lucene50SkipWriter}
 */
public class FqlSkipWriter extends MultiLevelSkipListWriter {
    ...
    public FqlSkipWriter(int maxSkipLevels, int blockSize, int docCount, IndexOutput docOut, IndexOutput posOut, IndexOutput payOut) {
