...
import static org.fql.codec.postings.FqlPostingsFormat.*;
 ...
 * see {@link org.apache.lucene.codecs.lucene50.Lucene50PostingsReader}
 */
public class FqlPostingsReader extends PostingsReaderBase {

    private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(FqlPostingsReader.class);
    ...
    /** Sole constructor. */
    public FqlPostingsReader(SegmentReadState state) throws IOException {
        ...
        String docName = IndexFileNames.segmentFileName(state.segmentInfo.name, state.segmentSuffix, FqlPostingsFormat.DOC_EXTENSION);
        try {
            ...
            if (state.fieldInfos.hasProx()) {
                String proxName = IndexFileNames.segmentFileName(state.segmentInfo.name, state.segmentSuffix, FqlPostingsFormat.POS_EXTENSION);
                ...
                if (state.fieldInfos.hasPayloads() || state.fieldInfos.hasOffsets()) {
                    String payName = IndexFileNames.segmentFileName(state.segmentInfo.name, state.segmentSuffix, FqlPostingsFormat.PAY_EXTENSION);
    ...
    final class BlockDocsEnum extends PostingsEnum {
        ...
        public BlockDocsEnum(FieldInfo fieldInfo) throws IOException {
            this.startDocIn = FqlPostingsReader.this.docIn;
            this.docIn = null;
        ...
        public int advance(int target) throws IOException {
            ...
            if (docFreq > BLOCK_SIZE && target > nextSkipDoc) {
                ...
                if (skipper == null) {
                    ...
                    skipper = new FqlSkipReader(docIn.clone(),
                            MAX_SKIP_LEVELS,
                            indexHasPos,
                            indexHasOffsets,
                            indexHasPayloads);
    ...
    final class BlockPostingsEnum extends PostingsEnum {
        ...
        public BlockPostingsEnum(FieldInfo fieldInfo) throws IOException {
            this.startDocIn = FqlPostingsReader.this.docIn;
            this.docIn = null;
            this.posIn = FqlPostingsReader.this.posIn.clone();
            encoded = new byte[MAX_ENCODED_SIZE];
            indexHasOffsets = fieldInfo.getIndexOptions().compareTo(IndexOptions.DOCS_AND_FREQS_AND_POSITIONS_AND_OFFSETS) >= 0;
            indexHasPayloads = fieldInfo.hasPayloads();
        }
    ...
    final class EverythingEnum extends PostingsEnum {
        ...
        public EverythingEnum(FieldInfo fieldInfo) throws IOException {
            ...
            this.docIn = null;
            this.posIn = FqlPostingsReader.this.posIn.clone();
            this.payIn = FqlPostingsReader.this.payIn.clone();
            encoded = new byte[MAX_ENCODED_SIZE];
            indexHasOffsets = fieldInfo.getIndexOptions().compareTo(IndexOptions.DOCS_AND_FREQS_AND_POSITIONS_AND_OFFSETS) >= 0;
            if (indexHasOffsets) {
